...
Public Class formSSGVoting

    Private Sub formSSGVoting_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        LoadPositions()
        ClearAllFields()
    End Sub
...
#Region "GOVERNOR"
    Private Sub LoadGov()
        Try
            query = "SELECT CandidateID, CONCAT(Lastname, ', ', Firstname, ' ', Middlename, '   - ', PartyName) as CanName,PicFile FROM Candidate as C, Party as P, Positions as Po, voting_level as L WHERE L.LevelID = Po.LevelID AND C.PartyID = P.PartyID AND C.PositionID = Po.PositionID AND PositionName = 'Governor' AND LevelName = 'SSG Executive Branch'  ORDER BY Lastname, Firstname ASC"
            Connection()
            cmbGov.Items.Clear()
...
#Region "VICE-GOVERNOR"
    Private Sub LoadViceGov()
        Try
            query = "SELECT CandidateID, CONCAT(Lastname, ', ', Firstname, ' ', Middlename, '   - ', PartyName) as CanName FROM Candidate as C, Party as P, Positions as Po, voting_level as L WHERE L.LevelID = Po.LevelID AND C.PartyID = P.PartyID AND C.PositionID = Po.PositionID AND PositionName = 'Vice-Governor' AND LevelName = 'SSG Executive Branch'  ORDER BY Lastname, Firstname"
            Connection()
...
#Region "SECRETARY"
    Private Sub LoadSecretary()
        Try
            query = "SELECT CandidateID, CONCAT(Lastname, ', ', Firstname, ' ', Middlename, '   - ', PartyName) as CanName FROM Candidate as C, Party as P, Positions as Po, voting_level as L WHERE L.LevelID = Po.LevelID AND C.PartyID = P.PartyID AND C.PositionID = Po.PositionID AND PositionName = 'Secretary' AND LevelName = 'SSG Executive Branch'  ORDER BY Lastname, Firstname"
            Connection()
...
#Region "TREASURER"
    Private Sub LoadTreasurer()
        Try
            query = "SELECT CandidateID, CONCAT(Lastname, ', ', Firstname, ' ', Middlename, '   - ', PartyName) as CanName FROM Candidate as C, Party as P, Positions as Po, voting_level as L WHERE L.LevelID = Po.LevelID AND C.PartyID = P.PartyID AND C.PositionID = Po.PositionID AND PositionName = 'Treasurer' AND LevelName = 'SSG Executive Branch'  ORDER BY Lastname, Firstname"
            Connection()
...
#Region "BUSINESS MANAGER"
    Private Sub LoadBusinessManager()
        Try
            query = "SELECT CandidateID, CONCAT(Lastname, ', ', Firstname, ' ', Middlename, '   - ', PartyName) as CanName FROM Candidate as C, Party as P, Positions as Po, voting_level as L WHERE L.LevelID = Po.LevelID AND C.PartyID = P.PartyID AND C.PositionID = Po.PositionID AND PositionName = 'Business Manager' AND LevelName = 'SSG Executive Branch'  ORDER BY Lastname, Firstname"
            Connection()
            cmbBMan.Items.Clear()
            sqlda = New MySqlDataAdapter(query, conn)
            sqlds = New DataSet
...
#Region "AUDITOR"
    Private Sub LoadAuditor()
        Try
            query = "SELECT CandidateID, CONCAT(Lastname, ', ', Firstname, ' ', Middlename, '   - ', PartyName) as CanName FROM Candidate as C, Party as P, Positions as Po, voting_level as L WHERE L.LevelID = Po.LevelID AND C.PartyID = P.PartyID AND C.PositionID = Po.PositionID AND PositionName = 'Auditor' AND LevelName = 'SSG Executive Branch'  ORDER BY Lastname, Firstname"
            Connection()
...
#Region "PIO"
    Private Sub LoadPIO()
        Try
            query = "SELECT CandidateID, CONCAT(Lastname, ', ', Firstname, ' ', Middlename, '   - ', PartyName) as CanName FROM Candidate as C, Party as P, Positions as Po, voting_level as L WHERE L.LevelID = Po.LevelID AND C.PartyID = P.PartyID AND C.PositionID = Po.PositionID AND PositionName = 'PIO' AND LevelName = 'SSG Executive Branch'  ORDER BY Lastname, Firstname"
            Connection()
            cmbPIO.Items.Clear()
            sqlda = New MySqlDataAdapter(query, conn)
            sqlds = New DataSet
